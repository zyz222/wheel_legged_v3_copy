...
problem_setup problem_configuration;             //MPC配置参数的结构体
u8 gait_data[K_MAX_GAIT_SEGMENTS];              //步态数据  步态周期，相位等
pthread_mutex_t problem_cfg_mt;             //问题配置的互斥锁
pthread_mutex_t update_mt;                 //更新问题的互斥锁
update_data_t update;                      //更新问题的结构体
pthread_t solve_thread;                    //MPC线程
