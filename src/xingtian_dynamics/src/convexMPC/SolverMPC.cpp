...
#include "thirdParty/JCQP/QpProblem.h"
...
void solve_mpc(update_data_t* update, problem_setup* setup)
{
  ...
  //I_world = robot_rs.R_yaw.transpose() * robot_rs.I_body * robot_rs.R_yaw;
  //cout<<robot_rs.R_yaw<<endl;
  ct_ss_mats(I_world,robot_rs.m,robot_rs.r_feet,robot_rs.R_yaw,A_ct,B_ct_r, update->x_drag);
