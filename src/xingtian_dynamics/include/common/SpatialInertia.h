...
#ifndef EF4FDA96_BF22_44BB_8821_1641F01AE118
#define EF4FDA96_BF22_44BB_8821_1641F01AE118
 ...
 */
template <typename T>
class SpatialInertia {              //封装刚体的惯性和质量分布
 public:
   ...
   * Flip inertia matrix around an axis.  This isn't efficient, but it works!
   空间惯性矩阵是一个 ​6×6 对称矩阵，其结构如下：
    I=[I   m[c]×  
      ​​m[c]×  ⊤​mI3​​]

    ​左上角 3×3：旋转惯性张量（考虑质心偏移）
    ​右上/左下 3×3：质心位置的叉积矩阵（[c]×）
    ​右下角 3×3：质量项（m 为质量）
...
extern template class SpatialInertia<double>;
#endif  // LIBBIOMIMETICS_SPATIALINERTIA_H


#endif /* EF4FDA96_BF22_44BB_8821_1641F01AE118 */
